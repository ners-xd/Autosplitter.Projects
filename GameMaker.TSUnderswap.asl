...
state("TS!Underswap", "v2.1.1")
{
    double kills : 0x7776E0, 0x8, 0x10, 0x1D10, 0x10;

    float  playerX    : 0x764778, 0x0,  0x1DA0, 0x18, 0x70,  0x10,  0xEC;
    double namePhase  : 0xA050A0, 0x90, 0x8,    0x10, 0x220, 0x0;
    double menuOption : 0xA050A0, 0x90, 0x1A0,  0x8,  0x10,  0x230, 0x0;
    double liftState  : 0xA26590, 0x8,  0x8,    0x10, 0x330, 0x0;

    string32 menuContinue : 0xA050A0, 0x90, 0x1A0, 0x8,  0x10, 0xA0, 0x0, 0x8, 0x80, 0x10;
    string32 song         : 0xA050A0, 0x90, 0x8,   0x10, 0xF0, 0x0,  0x0, 0x0;
}
...
init
{
    ...
    switch(hash)
    {
        ...
        case "A00D2A5C3F307DCC66472D2659722CEE":
            version = "v2.1.1";
            break;
        ...
        default:
            ...
            (
                ...
                "Supported versions: v1.0.8, v2.0.4, v2.1.1.",
