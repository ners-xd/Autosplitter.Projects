...
state("Undertale Yellow", "v1.0")
{
    ...
    double soulSpeed       : 0xA3FD40, 0x180, 0x90,  0x78, 0x28, 0x28, 0x38, 0x48, 0x10, 0x1F0, 0x4A0; // obj_heart_battle_fighting_parent.walk_speed
...
state("Undertale Yellow", "v1.1")
{
    ...
    double soulSpeed       : 0xA3FD40, 0x180, 0x90,  0x78, 0x28, 0x28, 0x38, 0x48, 0x10, 0x1F0, 0x4A0;
