...
startup
{
    ...
    vars.splits = new Dictionary<string, Func<dynamic, dynamic, bool>>()
    {
        ...
        {"area1",                (org, cur) => cur.map == 205 && (cur.eventID == 5 || cur.eventID == 6) && cur.eventPage == 0 && org.eventLine < 5 && cur.eventLine == 5},
        {"area2",                (org, cur) => cur.map == 212 && (cur.eventID == 5 || cur.eventID == 6) && cur.eventPage == 0 && org.eventLine < 16 && cur.eventLine == 16},
        {"area3",                (org, cur) => cur.map == 214 && (cur.eventID == 3 || cur.eventID == 5) && cur.eventPage == 0 && org.eventLine < 5 && cur.eventLine == 5},
