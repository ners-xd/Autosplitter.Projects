// Undertale Wildfire Demo Autosplitter by NERS
...
init
{
    ...
    Func<int, string, IntPtr> scan = (o, sig) =>
    {
        ...
        if(ptr == IntPtr.Zero) throw new NullReferenceException("[Undertale Wildfire Demo] Signature scanning failed");
        print("[Undertale Wildfire Demo] Signature found at " + ptr.ToString("X"));
        return ptr;
    };
    ...
    switch(hash)
    {
        ...
        default:
            ...
            MessageBox.Show
            (
                "This version of the Undertale Wildfire Demo is not supported by the autosplitter.\nIf you are playing an older version, update your game.\nIf not, please wait until the autosplitter receives an update.",
                "LiveSplit | Undertale Wildfire Demo", MessageBoxButtons.OK, MessageBoxIcon.Warning
            );
            break;
    }
...
onReset
{
    if(game != null)
    {
        ...
        print("[Undertale Wildfire Demo] All splits have been reset to initial state");
    }
}
...
update
{
    ...
    if(old.room != current.room)
        print("[Undertale Wildfire Demo] Room: " + old.room + " -> " + current.room);
}
...
split
{
    ...
    foreach(string splitKey in vars.splits.Keys)
    {
        ...
        {   
            ...
            print("[Undertale Wildfire Demo] Split triggered (" + splitKey + ")");
            return true;
        }
    }
}